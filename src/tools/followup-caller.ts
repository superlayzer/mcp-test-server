...
const URI = "ui://followup-caller/widget.html";

export function registerFollowupCallerResource(server: McpServer): void {
...
export function registerFollowupCallerTool(server: McpServer): void {
  server.registerTool(
    "followup_caller",
    {
